...
class SuperWebsiteSettingsController extends Controller
{
    /* ===== Utils ===== */
    ...
    public function trainerEdit()
    {
        ...
        return view('superadmin.website.trainer', compact(
            'coachFee',
            'showSocial',
            'defaultCover'
        ));
    ...
    public function customerEdit()
    {
        ...
        return view('superadmin.website.customer', compact('clientFee'));
    }
    ...
    public function appearanceEdit()
    {
        ...
        return view('superadmin.website.appearance', compact('searchBg', 'middleImg'));
    }
