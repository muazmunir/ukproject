...
class AdminCoachAnalyticsController extends Controller
{
    public function show(Request $request, Users $coach)
    {
        abort_unless(in_array((string) auth()->user()?->role, ['admin', 'manager'], true), 403);
        ...
        return view('admin.coaches.stats', compact(
            'coach',
            'currency',
            'periodLabel',
            'range',
