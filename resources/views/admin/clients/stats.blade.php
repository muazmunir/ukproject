...
@endphp
          ...
          <tr>
            <td>
              <div class="td-stack">
                <div class="td-main td-main--strong">#{{ $row->id }}</div>
              </div>
            </td>
...
<td>
  <div class="td-stack">
    <div class="td-main money-positive">{{ $fmt((int) $row->refund_total_minor) }}</div>
        ...
        @empty
          <tr>
            <td colspan="11" class="empty-cell text-capitalize">No reservation activity found.</td>
          </tr>
        @endforelse
      </tbody>
    </table>
  ...
  default => $dispute->decision_action
    ...
    : '—',
          ...
          <tr>
            <td>
              <div class="td-stack">
                <div class="td-main td-main--strong">#{{ $dispute->id }}</div>
              </div>
            </td>
