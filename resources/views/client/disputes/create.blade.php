...
<div class="dv-page">
  <div class="card">
    <div class="card__head">
      ...
      <a class="btn btn--ghost" href="{{ route('client.disputes.index') }}">Back</a>
    </div>

    <form method="POST" action="{{ route('client.disputes.store', $reservation) }}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="dv-actions">
        <button class="btn btn-black bg-black text-white rounded-pill text-white" type="submit">Submit Dispute</button>
      </div>
    </form>
  </div>
</div>
