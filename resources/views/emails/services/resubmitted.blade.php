...
<body style="font-family: Arial, sans-serif; line-height:1.6;">
  ...
  <p>Your service <strong>{{ $service->title }}</strong> was updated successfully.</p>

  <p>Because you made changes, the service is now back <strong>under review</strong> to ensure everything is correct.</p>
