...
<body style="font-family: Arial, sans-serif; line-height:1.6;">
  ...
  <p>Your service <strong>{{ $service->title }}</strong> has been <strong>enabled</strong>.</p>

  <p>If the service is approved and active, it will be visible to clients again.</p>
