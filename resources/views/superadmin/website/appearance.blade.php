...
@section('content')
    <section class="card settings-card">
        ...
        <form method="post" action="{{ route('superadmin.settings.appearance.update') }}" enctype="multipart/form-data"
            ...
            <div class="field">
                @include('superadmin.website._image_uploader', [
                    ...
                    'deleteRoute' => route('superadmin.settings.appearance.search_bg.delete'),
            ...
            <div class="field">
                @include('superadmin.website._image_uploader', [
                    ...
                    'deleteRoute' => route('superadmin.settings.appearance.middle_banner.delete'),
