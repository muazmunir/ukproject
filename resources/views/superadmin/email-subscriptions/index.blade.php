@extends('superadmin.layout') {{-- change to your admin layout --}}
...
<div class="container-fluid py-4">
  ...
  <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
    ...
    <div class="d-flex gap-2">
      ...
      <a class="btn btn-dark btn-sm" href="{{ route('superadmin.email-subscriptions.compose') }}">
  ...
  <div class="card shadow-sm border-0 mb-3">
    <div class="card-body">
      <form class="row g-2 align-items-end" method="GET" action="{{ route('superadmin.email-subscriptions.index')
 }}">
        ...
        <div class="col-12 col-md-3 d-flex gap-2">
          ...
          <a class="btn btn-outline-secondary w-100" href="{{ route('superadmin.email-subscriptions.index')
 }}">
            Reset
          </a>
        </div>
      ...
      <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
          ...
          @forelse($subscribers as $s)
            ...
            <td>
  @if($s->is_active)
    <span class="badge bg-success zv-badge">
      <i class="bi bi-check2-circle me-1"></i> Active
    </span>
  @else
    <span class="badge bg-secondary zv-badge">
  ...
  @endif
              ...
              <td class=" pe-4">
                <div class="d-inline-flex gap-2">
                  <form method="POST" action="{{ route('superadmin.email-subscriptions.toggle', $s) }}">
                    @csrf
                    @method('PATCH')
  ...
  <span class="zv-slider"></span>
        ...
        data-action="{{ route('superadmin.email-subscriptions.destroy', $s) }}"
