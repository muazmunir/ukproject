...
<section class="stats-page">
  <div class="top-card">
    <div class="top-head">
      <div class="identity-wrap">
        <a href="{{ route('superadmin.coaches.index') }}" class="back-link my-3">
  ...
  <section class="panel">
    <div class="zv-filterbar">
      <form method="GET"
            action="{{ route('superadmin.coaches.stats', $coach->id) }}"
            class="zv-filterform zv-filterform--{{ $active }}"
            id="js-admin-coach-filter">

        <input type="hidden" name="range" value="{{ $active }}">

        <div class="zv-filter-pills" role="group" aria-label="Date filters">
        ...
        <div class="zv-filter-controls">
          @if($showDay)
            <div class="zv-filter-slot zv-filter-slot--day">
              <label class="zv-range-field js-day">
                <span>Day</span>
          ...
          @if($showYear)
            <div class="zv-filter-slot zv-filter-slot--year">
              <label class="zv-range-field js-year">
                <span>Year</span>
                <select name="year">
          ...
          @if($showMonth)
            <div class="zv-filter-slot zv-filter-slot--month">
              <label class="zv-range-field js-month">
                <span>Month</span>
                <select name="month">
                  @for($m=1;$m<=12;$m++)
          ...
          @if($showCustom)
            <div class="zv-filter-slot zv-filter-slot--from">
              <label class="zv-range-field js-from">
                <span>From</span>
                <input type="date" name="from" value="{{ request('from') }}">
              </label>
            </div>

            <div class="zv-filter-slot zv-filter-slot--to">
              <label class="zv-range-field js-to">
                <span>To</span>
          ...
          <div class="zv-filter-actions">
            <button type="submit" class="btn-filter">Apply</button>

            <a href="{{ route('superadmin.coaches.stats', $coach->id) }}"
               class="zv-linkbtn"
